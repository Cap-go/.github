...
This document outlines the governance model for Capgo. This includes detailed descriptions of different roles, nomination processes, code review processes, and Code of Conduct enforcement.
...
**Anything that supports the Capgo community is a valuable contribution!**

All types of contribution are meaningful. This can include code changes, type fixes, Discord activity, and even posting about Capgo to your personal blog. No contribution is too small!

Anyone can become an Capgo contributor (yes, even you!). Engineering ability is not required. Our goal is to recognize all contributors to the project regardless of skill, experience or background.
...
Contributor levels are available to **all members** of the Capgo community, regardless of coding skill or experience.

Two important things that we look for in a contributor are:

- **Being here** - Everyone's time is valuable, and the fact that you're here and contributing to Capgo is amazing! Thank you for being a part of this project with us.
...
Have you done something (big or small) to contribute to the health, success, or growth of Capgo? **Congratulations, you're officially recognized as a contributor to the project!**
...
- Blogging, Vlogging, Podcasting, and Livestreaming about Capgo.
...
The **Maintainer** role is available to contributors who want to join the team and take part in the long-term maintenance and growth of Capgo.

The Maintainer role is critical to the long-term health of Capgo. Maintainers act as the first line of defense when it comes to new issues, pull requests and Discord activity. Maintainers are most likely the first people that a user will interact with on Discord or GitHub.
...
- Invitation to the `Cap-go` organization on GitHub.
...
- Ability to push branches directly to the `Cap-go` GitHub organization (personal forks no longer needed).
...
- Bring a friendly, welcoming voice to the Capgo community.
...
The **Core** role is available to community members who have a larger-than-usual impact on the Capgo project and community. They are seen as leaders in the project and are listened to by the wider Capgo community, often before they have even reached this level. A Core member is recognized for contributing a significant amount of time and energy to the project through issues, pull requests, bug fixes, implementing advanced enhancements/features, and/or actively posting on Discord.
...
- Ownership over the long-term health and success of Capgo.
...
Because of these limitations, this type of Core membership is useful for anyone who has been brought in to work on or contribute to the Capgo project without rising through our normal contributor levels. For example: an Capgo designer or developer advocate hired by The Capgo Technology Company to assist the community could be nominated for a Core Residency role without having a previously earned contributor level.
...
- `@team-docs` runs the `#docs` channel and organizes the growth and development of Capgo documentation.
- `@i18n-gang` runs the `#docs-i18n` channel and organizes translations in several languages.
- `@support-squad` runs the `#support-threads` channel and helps anyone who needs help using Capgo.

Many of these team roles can be browsed and joined automatically by visiting the `#manage-roles` channel in our Discord. Getting involved with a team is a great way to start contributing to Capgo!
...
The **TSC** is a special role available to Core members (L3 and above). TSC members are responsible for the growth and maintenance of the Capgo codebase.

TSC members are guardians over the Capgo codebase. Their duty is to ensure code quality, correctness and security.

A TSC member guides the direction of the project and ensures a healthy future for the Capgo codebase. TSC members are ultimately responsible for technical decision making when it comes to any changes to the Capgo codebase.

A TSC member has significant sway in software design decisions. For this reason, coding experience is critical for this role. TSC membership is one of the only roles that requires a significant contribution history of code to the Capgo project on GitHub.
...
**Staff** is a special designation for employees of [The Capgo Technology Company](https://astro.build/company).
...
Contributor roles are granted for as long as the person wishes to engage with the project. However, over time an active community member may choose to step away from the Capgo project to work on other things. Moving on from a project is a natural and well-understood part of any open source community, and we celebrate it!
...
**I have some exciting news — you have been awarded the role of Maintainer (L2 Contributor) in the Capgo community!**
...
We would be thrilled to have your help building the future of Capgo. There is no required time commitment: you can continue to contribute as often or as little as you'd like. This is mainly a chance to recognize your contributions and give you more privileges in Discord and GitHub.
...
*PS: As a reminder, our Governance document describes the following privileges and responsibilities for the  **L2 - Maintainer** role: https://github.com/Cap-go/.github/blob/main/GOVERNANCE.md*
```
...
I have some exciting news—you’ve been nominated and accepted as a member of the Capgo Core team! The Core team held a vote and overwhelmingly agree that you would be a great addition to the team. Congratulations! Thanks for all of your significant contributions to Capgo to date and your continued dedication to this project and our community. We would be thrilled to have your help ensuring a healthy future for Capgo!
